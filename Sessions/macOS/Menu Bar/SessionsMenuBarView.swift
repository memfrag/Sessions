...
/// Contents of the menu bar popover: server status, a row per workspace
/// (with jump-to-tab rows for anything wanting attention), and app
/// actions.
struct SessionsMenuBarView: View {
    ...
    private var restartServerButton: some View {
        Button {
    ...
    private var quitAndStopButton: some View {
        Button {
